        ...
        if special_offer_category == 'deal' or special_offer_category == 'clearance':
            ...
            if special_offer_price is None:
                self._errors['special_offer_price'] = self.error_class([
                    "Valid special offer price required while offer is selected. Special offer price can't be a negative number or zero, and it has to be lower than the original price."])
